    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-sm-8">
                    ...
                    <div class="card text-center">
                        <div class="card-header">
                            <p><strong>Importación a pedido de Repuestos y Accesorios CATERPILLAR</strong></p>
                        </div>
                        <div class="card-body">
            ...
            <div class="row mt-5">
                    ...
                    <div class="col-sm-4">
                        <div class="card-body">
                            <img class="card-img-top imgcard" src="../assets/img/landing/cat/uno.jpg" alt="Card image cap">
                            
                        </div>
                        <div class="card-body">
                            <img class="card-img-top imgcard" src="../assets/img/landing/cat/caterpillar2.jpg" alt="Card image cap">
